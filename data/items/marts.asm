...
LavenderMartClerkText::
	script_mart GREAT_BALL, SUPER_POTION, POTION, ESCAPE_ROPE, SUPER_REPEL, ANTIDOTE, BURN_HEAL, ICE_HEAL, PARLYZ_HEAL

CeladonMart2FClerk1Text::
	script_mart GREAT_BALL, SUPER_POTION, POTION, SUPER_REPEL, ANTIDOTE, BURN_HEAL, ICE_HEAL, AWAKENING, PARLYZ_HEAL
...
CeladonMart4FClerkText::
	script_mart POKE_DOLL, FIRE_STONE, THUNDER_STONE, WATER_STONE, LEAF_STONE, TRADE_STONE
...
FuchsiaMartClerkText::
	script_mart ULTRA_BALL, GREAT_BALL, SUPER_POTION, POTION, FULL_HEAL, SUPER_REPEL

UnusedMartClerkText:: ; unreferenced
	script_mart GREAT_BALL, HYPER_POTION, SUPER_POTION, POTION, FULL_HEAL

CinnabarMartClerkText::
	script_mart ULTRA_BALL, GREAT_BALL, HYPER_POTION, SUPER_POTION, MAX_REPEL, ESCAPE_ROPE, FULL_HEAL

SaffronMartClerkText::
	script_mart GREAT_BALL, HYPER_POTION, SUPER_POTION, MAX_REPEL, ESCAPE_ROPE, FULL_HEAL

IndigoPlateauLobbyClerkText::
	script_mart ULTRA_BALL, GREAT_BALL, FULL_RESTORE, MAX_POTION, HYPER_POTION, FULL_HEAL, MAX_REPEL
